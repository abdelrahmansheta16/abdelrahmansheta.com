...
export interface GuardConfig {
  ...
  refusals: Record<Exclude<GuardRule, "canary" | "json_shape"> | "generic", { en: string; ar: string }>;
...
export interface Guard {
  ...
  checkSentence(sentence: string, ctx: { locale: Locale; lastUserTurn?: string; digitCarry?: string }): GuardVerdict;
