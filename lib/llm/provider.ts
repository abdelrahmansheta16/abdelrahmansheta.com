...
export function createDeepSeekProvider(_opts: {
  apiKey: string;
  baseUrl?: string;
  model?: string;
}): ProviderAdapter {
...
export function createAnthropicProvider(_opts: {
  apiKey: string;
  model?: string;
}): ProviderAdapter {
...
export function withFailover(
  _primary: ProviderAdapter,
  _fallback: ProviderAdapter,
  _opts?: { firstTokenTimeoutMs?: number },
): ProviderAdapter {
